...
class ForumPostsController < ApplicationController
  ...
  # All actions need a parent ForumThread object to work with.
  before_filter :find_forum_thread, :only => [ :show, :new, :create, :edit, :update, :destroy ]
  ...
  before_filter :check_authorization_for_forum_post, :only => [ :edit, :update, :destroy ]
...
protected
  ...
  def ensure_forum_post_is_not_a_start_post
    redirect_to [ @forum_thread.forum_topic, @forum_thread ] if @forum_post.is_start_post?
  end

  # Checks whether the user is authorized to perform the action.
  def check_authorization_for_forum_post
