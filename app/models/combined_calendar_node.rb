# This model is used to represent a news viewer item, that belongs to a
# +news_viewer+. It is associated with a +news_item+.
#
# *Specification*
#
# Attributes
...
# Preconditions
#
# * Requires the +news_item+ this +news_viewer_item+ is associated with, to be
#   unique for every +news_viewer+.
#
