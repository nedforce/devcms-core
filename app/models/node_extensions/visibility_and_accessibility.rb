module NodeExtensions::VisibilityAndAccessibility
  ...
  def set_accessibility!(accessible)
    if !(self.content_class <= Section)
      self.errors.add(:base, I18n.t('activerecord.errors.models.node.attributes.base.can_only_set_accessibility_on_sections'))
      false
    elsif self.is_global_frontpage? || self.contains_global_frontpage?
      self.errors.add(:base, I18n.t('activerecord.errors.models.node.attributes.base.cant_make_node_public_when_it_has_a_private_ancestor'))
      false
    elsif !accessible
    ...
    self.errors.add(:base, I18n.t('activerecord.errors.models.node.attributes.base.set_accessibility_failed'))
    false
  end
  ...
  def set_visibility!(visible)
    if self.is_global_frontpage? || self.contains_global_frontpage?
      ...
      self.errors.add(:base, I18n.t('activerecord.errors.models.node.attributes.base.cant_make_node_visible_when_it_has_a_hidden_ancestor'))
      false
    else
