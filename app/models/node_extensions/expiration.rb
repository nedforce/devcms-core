module NodeExtensions::Expiration
  ...
  def ensure_valid_responsible_user_role
    errors.add(:base, I18n.t('acts_as_content_node.responsible_user_requires_role')) unless self.responsible_user.blank? || self.responsible_user.has_role_on?(['admin', 'editor', 'final_editor'], self)
  end
