...
class NewsViewerArchive < ActiveRecord::Base
  ...
  after_destroy { |viewer_archive| viewer_archive.news_viewer.news_items.delete(viewer_archive.news_archive.news_items) if viewer_archive.news_viewer && viewer_archive.news_archive }
end
