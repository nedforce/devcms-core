...
#     assert assigns(:results)
#     assert assigns(:results).size > 0
#     assert assigns(:results).stop_page
#   end
# 
...
#     login_as :reader
#     post :index, :query => 'koffiemokkenverzamelaar', :search_scope => "node_#{nodes(:hidden_section_node).id}"
#     assert assigns(:private_menu_items).include?(nodes(:hidden_section_node))
#     assert_response :success
#     assert_not_nil assigns(:results)
#     assert_equal nodes(:hidden_section_node), assigns(:top_node), "Top node should remain the same!"
#   end
# 
