...
# Unit tests for the +Forum+ model.
class ForumTest < ActiveSupport::TestCase
  ...
  test 'should find last updated forum threads' do
    @bewoners_forum.forum_topics.each do |topic|
      ...
      last_thread  = topic.forum_threads.order(created_at: :desc).first
  ...
  def create_forum(options = {})
    Forum.create({
      ...
      title: 'DevCMS forums, the best there are!',
      description: 'Enjoy!'
    }.merge(options))
  end
end
