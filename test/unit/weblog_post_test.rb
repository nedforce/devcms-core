...
class WeblogPostTest < ActiveSupport::TestCase
  ...
  def test_url_alias_for_news_item_with_publication_start_date
    ...
    assert_equal "gemeente-weblogs/henk-weblog/#{start_date.year}/#{start_date.month}/#{start_date.day}/some-interesting-title", wp.node.reload.url_alias
  end

  def test_url_alias_for_news_item_without_specified_publication_start_date
    wp = create_weblog_post
    created_at = wp.created_at
    assert_equal "gemeente-weblogs/henk-weblog/#{created_at.year}/#{created_at.month}/#{created_at.day}/some-interesting-title", wp.node.reload.url_alias
  end
