...
protected
  ...
  def create_page(options = {})
    Page.create_for_user(@arthur, { :parent => nodes(:editor_section_node), :title => "Page title", :preamble => "Ambule", :body => "Page body", :expires_on => 1.day.from_now.to_date }.merge(options)).reload
  end
