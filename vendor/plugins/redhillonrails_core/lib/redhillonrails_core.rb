...
if defined?(ActiveRecord::ConnectionAdapters::IBM_DBAdapter) then
  ActiveRecord::ConnectionAdapters::IBM_DBAdapter.send(:include, RedHillConsulting::Core::ActiveRecord::ConnectionAdapters::IBM_DBAdapter)
end
