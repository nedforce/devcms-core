  ...
  module Archive #:nodoc:
    ...
    module InstanceMethods
      ...
      def find_weeks_with_items_for_year(year)
        ...
        star_of_next_cwyear = (Date.valid_commercial?(year, 53, 7).nil? ? Date.commercial(year, 52, 7) : Date.commercial(year, 53, 7)).end_of_week + 1.day
