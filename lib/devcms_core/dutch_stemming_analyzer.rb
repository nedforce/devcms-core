module DevcmsCore
  ...
  # It uses the Dutch Snowball stemmer and the list of Dutch stop words by
  # default.
  class DutchStemmingAnalyzer < Ferret::Analysis::Analyzer
    ...
    # Stem a stream of tokens by converting them to lowercase and using the
    # Dutch Snowball stemmer plus the list of stop words that the stemmer has
