	...
	tinymce.create('tinymce.plugins.XHTMLXtrasPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceAbbr', function() {
                ...
                var abbr = (selection.getNode().tagName == "ABBR" || selection.getNode().tagName == "abbr") ? (selection.getNode().textContent != undefined ? selection.getNode().textContent : selection.getNode().innerText ) : selection.getContent({format : 'text'});
				alert('BOE!');
				ed.windowManager.open({
					file:'/admin/abbreviations/new?node_id='+site_node_id+'&abbr='+abbr,
